...
public class CreateMovieCommandHandlerTests
{
    ...
    private readonly Mock<IMovieDirectorRepository> _movieDirectorRepository;
    ...
    public CreateMovieCommandHandlerTests()
    {
        ...
        _movieDirectorRepository = MovieTestHelpers.PrepareMovieDirectorRepository();
    }
    ...
    public async Task CreateMovieCommandHandlerShouldCreateNewMovieAndSuccessfullyStore()
    {
        ...
        var handler = new CreateMovieCommandHandler(_movieRepository.Object, _movieActorRepository.Object, _movieDirectorRepository.Object);
    ...
    public async Task CreateMovieCommandHandlerWithWrongDirectorIdShouldThrowMovieDirectorNotFoundException()
    {
        ...
        var handler = new CreateMovieCommandHandler(_movieRepository.Object, _movieActorRepository.Object, new Mock<IMovieDirectorRepository>().Object);
    ...
    public async Task CreateMovieCommandHandlerWithInsufficientActorsShouldThrowInsufficientMovieActorsException()
    {
        ...
        var handler = new CreateMovieCommandHandler(_movieRepository.Object, new Mock<IMovieActorRepository>().Object, _movieDirectorRepository.Object);
